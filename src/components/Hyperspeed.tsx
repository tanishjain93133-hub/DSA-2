  ...
  useEffect(() => {
    ...
    class App {
      ...
      tick() {
        ...
        if (resizeRendererToDisplaySize(this.renderer, (w: number, h: number) => this.setSize(w, h))) {
    ...
    class CarLights {
      ...
      init() {
        ...
        for (let i = 0; i < options.lightPairsPerRoadWay; i++) {
          ...
          let speedVal = random(this.speed);

          let carLane = i % options.lanesPerRoad;
          let laneX = carLane * laneWidth - options.roadWidth / 2 + laneWidth / 2;

          let carWidth = random(options.carWidthPercentage) * laneWidth;
          let carShiftXStr = random(options.carShiftX) * laneWidth;
          laneX += carShiftXStr;
