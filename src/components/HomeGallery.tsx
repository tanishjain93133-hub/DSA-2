...
const GALLERY_ITEMS = [
  ...
  { image: 'https://lh3.googleusercontent.com/d/1lT_rM9G9pB9t4vHywDCfQy7h5OHwJM41', text: 'Achira Diamond & Fashion' },
  { image: 'https://lh3.googleusercontent.com/d/1ATpVoCZUuKvgssfy4TcClIPCA6v8K3yz', text: 'JS House' },
  { image: 'https://lh3.googleusercontent.com/d/1_BEEwFeRswSl-qmhg6cGM3CSVZBNxitc', text: 'JD Office' },
  { image: 'https://lh3.googleusercontent.com/d/18wghnSqoU4DceWGwb3OrGqMIb-bCrx_4', text: 'DHS House' },
  { image: 'https://lh3.googleusercontent.com/d/1IvJZ2tMlDc86dsptcjWoTjVBbn2GLJXe', text: 'Subtle Sanctuary' },
  ...
  { image: 'https://lh3.googleusercontent.com/d/1lT_rM9G9pB9t4vHywDCfQy7h5OHwJM41', text: 'Achira Diamond & Fashion Detail' },
  ...
  { image: 'https://lh3.googleusercontent.com/d/16UwjT1SSzMIS4bVDiB8ZcntJuJcSwtrQ', text: 'Commercial Hub' },
  ...
  { image: 'https://lh3.googleusercontent.com/d/1n1BRt7ypqRy_2DlVe1vLwKxtfrSIOAor', text: 'Office Space' },
  { image: 'https://lh3.googleusercontent.com/d/16UwjT1SSzMIS4bVDiB8ZcntJuJcSwtrQ', text: 'A & A Wealth Detail' },
  { image: 'https://lh3.googleusercontent.com/d/1ZfjIAL296LD5uhCuifOGUUhAAFEkFWoB', text: 'iFlair Office' },
      ...
      <div className="max-w-7xl mx-auto px-6 mb-16 text-center">
        ...
        >
          ...
          <h2 className="text-white text-5xl md:text-8xl font-thin tracking-widest uppercase">
            Project <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-cyan via-white to-electric-purple font-bold">Spheres</span>
          </h2>
        </motion.div>
      </div>
